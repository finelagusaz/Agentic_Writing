...
| `/setup-arc` | 対話回答（テーマ・アーク設計） | `story/scenario-arc.md`, `story/character-arcs.md`, `story/arc-design-progress.md`, `story/series-tracker.md`（初期化） |
...
| `story/series-tracker.md` | 横断追跡テンプレート | `/setup-world` or `/setup-arc` |
...
| `story/series-tracker.md` | Step 7(c) | 横断指標・構成パターン履歴・感覚レンズ履歴・アーク乖離チェック更新 |
...
### 8.6 arc-observer の提案権限（Phase 2）
| 区分 | 内容 |
|-----|------|
